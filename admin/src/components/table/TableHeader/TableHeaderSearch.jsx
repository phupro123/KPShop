...
const TableHeaderSearch = ({ field, groupKey, onChangeFilter }) => {
  const [isShowSearchFieldDropdown, setIsShowSearchFieldDropdown] =
    useState(false);
  ...
  return (
    <div className="group relative z-20  mb-4 mr-4 flex flex-shrink-0 items-center rounded-lg border-2 border-gray-100 bg-gray-50 focus-within:border-gray-200 focus-within:bg-gray-100 hover:border-gray-200 hover:bg-gray-100">
      <Input
        ...
        label="Search"
        labelPostfix={
          <BiSearch className="flex-shrink-0 pt-px text-gray-400" size={16} />
        }
        value={searchValue}
