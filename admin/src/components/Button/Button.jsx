...
const Button = ({
  ...
  switch (color) {
    ...
    case "blue":
      colorClassNames +=
        "bg-sky-700  hover:bg-sky-800  text-white  ring-gray-200 disabled:ring-gray-200";
      spinnerColorClassNames += "border-gray-400";
      break;
    case "orange":
      colorClassNames +=
    ...
    case "gray":
      colorClassNames +=
        "bg-gray-700  hover:bg-gray-800  text-white ring-gray-200 disabled:ring-gray-200";
      spinnerColorClassNames += "border-gray-400";
      break;
    default:
      ...
      spinnerColorClassNames +=
        disabled === true ? "border-white" : "border-gray-400";
  }
